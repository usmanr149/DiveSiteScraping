...
class DiscoverMexicoSpider(scrapy.Spider):
    name = "divescover_mexico"
    allowed_domains = ["divescover.com"]
    start_urls = ["https://divescover.com/dive-centers/mexico"]
    ...
    def parse(self, response):
        ...
        if response.css('.pagination a')[-1].css('a ::text').get() == 'Next':
            ...
            url = 'https://divescover.com/dive-centers/mexico' + next_page
